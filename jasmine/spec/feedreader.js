...
//Credit: https://matthewcranford.com/feed-reader-walkthrough
        /* TODO: Write a test that loops through each feed
         * in the allFeeds object and ensures it has a URL defined
         * and that the URL is not empty.
         */
        it('AllFeeds object has a URL that is defined', function () {
    ...
    describe('A test suite named menu is defined', function () {
        ...
        it('Menu changes visibility when menu icon is clicked', function () {
            const testVisibility = $('.menu-icon-link');
            testVisibility.click();
    ...
    describe('A test suite named Initial Entries is defined', function () {
    ...
    describe('New Feed Selection is defined', function () {
        ...
        it('loadFeed function content changes when a new Feed is loaded', function (load) {
